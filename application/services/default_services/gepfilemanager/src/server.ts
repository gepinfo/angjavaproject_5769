...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_angjavaproject_5769;
            let db_auth = result.data.DB_AUTH_angjavaproject_5769;
            let db_coll = result.data.DB_COLL_angjavaproject_5769;
